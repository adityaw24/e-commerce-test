...
import { ModalAddProduct, ModalDeleteProduct, ModalEditProduct } from './component'
import { IconContext } from 'react-icons'

const MasterProduct = () => {
    const column = ['Action', 'No', 'Code', 'Product Name', 'Description', 'Qty', 'Price']
    ...
    const handleModalDelete = () => showModalSet({...showModal, delete: !showModal.delete})
    ...
    return (
        <>
            ...
            <ModalDeleteProduct show={showModal.delete} handleModal={handleModalDelete} />
